...
const fetcher = () => {
    return new Promise ((resolve) => {
        const success = (position) => {
            axios.get(`https://webservice.recruit.co.jp/hotpepper/gourmet/v1/?key=${API_KEY}&lat=${position.coords.latitude}&lng=${position.coords.longitude}&genre=G001&count=20&format=jsonp`,
            {
